...
int* compute ( Mat &img1, Mat &img2 )
{
    ...
    std::cout << "match count: " << good_matches.size() << std::endl;
    std::cout << std::endl;
    ...
    Matx33f homography = findHomography ( points1, points2, CV_RANSAC, 3 );
    std::cout << "findHomography:" << std::endl;
    //std::cout << homography << std::endl;

    //std::cout << cos ( homography(0) ) << " " << sin ( homography(1) ) << std::endl;
    //std::cout << -sin ( homography(3) ) << " " << cos ( homography(4) ) << std::endl;
