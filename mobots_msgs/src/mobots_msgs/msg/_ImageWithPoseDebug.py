"""autogenerated by genmsg_py from ImageWithPoseDebug.msg. Do not edit."""
...
class ImageWithPoseDebug(roslib.message.Message):
  _md5sum = "b13d2865c5af2a64e6e30ab1b56e1dd5"
  _type = "mobots_msgs/ImageWithPoseDebug"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """#debug and shit
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ImageWithPoseDebug, self).__init__(*args, **kwds)
