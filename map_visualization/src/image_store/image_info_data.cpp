...
void image_info_data::save(const std::string &filename_)
{
	...
	pt.put("image_info.id.mobotID", id.mobotID);
	pt.put("image_info.id.imageID", id.imageID);
	
	pt.put("image_info.rel_pose.x", rel_pose.x);
	pt.put("image_info.rel_pose.y", rel_pose.y);
	pt.put("image_info.rel_pose.theta", rel_pose.theta);
	pt.put("image_info.rel_pose.enable", rel_pose.enable);
	
	pt.put("image_info.abs_pose.x", abs_pose.x);
	pt.put("image_info.abs_pose.y", abs_pose.y);
	pt.put("image_info.abs_pose.theta", abs_pose.theta);
	pt.put("image_info.abs_pose.enable", abs_pose.enable);
