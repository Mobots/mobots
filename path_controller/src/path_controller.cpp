...
void PathController::startWeg()
{
  ...
  nextPose_sub = nh->subscribe("waypoint", 30, &PathController::poseCallback, this);
  nextStampedPose_sub = nh->subscribe("waypointStamped", 2, &PathController::poseStampedCallback, this);
